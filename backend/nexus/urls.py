...
from apps.core.health import HealthView, ReadyView
from drf_spectacular.views import SpectacularAPIView, SpectacularSwaggerView, SpectacularRedocView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('api/v1/core/health/', HealthView.as_view(), name='health'),
    path('api/v1/core/ready/', ReadyView.as_view(), name='ready'),
